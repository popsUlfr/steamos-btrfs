...
config_load() {
  ...
  NONINTERACTIVE="${TMP_NONINTERACTIVE:-"$NONINTERACTIVE_DEFAULT"}"
  NOGUI="${TMP_NOGUI:-"$NOGUI_DEFAULT"}"
  NOAUTOUPDATE="${TMP_NOAUTOUPDATE:-"$NOAUTOUPDATE_DEFAULT"}"
  NOCONVERTHOME="${TMP_NOCONVERTHOME:-"$NOCONVERTHOME_DEFAULT"}"
  STEAMOS_BTRFS_HOME_MOUNT_OPTS="${TMP_STEAMOS_BTRFS_HOME_MOUNT_OPTS:-"$STEAMOS_BTRFS_HOME_MOUNT_OPTS_DEFAULT"}"
  STEAMOS_BTRFS_HOME_MOUNT_SUBVOL="${TMP_STEAMOS_BTRFS_HOME_MOUNT_SUBVOL:-"$STEAMOS_BTRFS_HOME_MOUNT_SUBVOL_DEFAULT"}"
  STEAMOS_BTRFS_ROOTFS_PACMAN_EXTRA_PKGS="${TMP_STEAMOS_BTRFS_ROOTFS_PACMAN_EXTRA_PKGS:-"$STEAMOS_BTRFS_ROOTFS_PACMAN_EXTRA_PKGS_DEFAULT"}"
